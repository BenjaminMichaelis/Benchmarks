...
[MemoryDiagnoser]
public class ClassUsingOptimizedLogging(ILogger logger)
{
    public void LogOnceNoParams() => Log.InformationalMessageNoParams(logger);

    public void LogOnceOneParam(string value1) => Log.InformationalMessageOneParam(logger, value1);

    public void LogOnceTwoParams(string value1, int value2) => Log.InformationalMessageTwoParams(logger, value1, value2);

    public void LogOnceUsingLoggerMessageWithoutLevelCheck(string value1, int value2) => Log.DebugMessage(logger, value1, value2);

    public void LogOnceUsingLoggerMessageWithLevelCheck(string value1, int value2) => Log.DebugMessageWithLevelCheck(logger, value1, value2);
